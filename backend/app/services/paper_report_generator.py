...
<div class="report-footer">
  <span>Generated by FL Research Monitor — Gemma4:e4b</span>
...
def render_paper_report(paper_data: dict, analysis_text: str) -> str:
