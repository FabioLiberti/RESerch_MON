...
def _pdf_footer_text() -> str:
    """LaTeX footer line — uses the centrally-configured template + escaping."""
    from app.services.app_settings import render_pdf_footer
    return render_pdf_footer(latex=True)


def _pdf_footer_text_plain() -> str:
    """Plain-text footer line for HTML/Markdown contexts."""
    from app.services.app_settings import render_pdf_footer
    return render_pdf_footer(latex=False)
